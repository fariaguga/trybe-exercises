const order = {
  ...
  const orderModifier = () => {
    ...
    "Olá Luiz Silva, o total do seu pedido de marguerita, pepperoni e 
    Coca-Cola Zero é R$ 50,00."
     ...
     console.log(`Olá Luís Silva, o total do seu pedido de marguerita, peperoni e Coca-Cola Zero é R$ ${newTotal},00`);
  }
